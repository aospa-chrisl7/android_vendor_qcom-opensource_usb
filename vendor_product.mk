...
ifneq ($(filter bengal blair monaco pitti trinket,$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter bengal kona crow trinket lahaina taro blair kalama pineapple monaco pitti niobe volcano anorak61,$(TARGET_BOARD_PLATFORM)),)
